...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/Navigine/Navigine Framework/Navigine.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ObjectMapper/ObjectMapper.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SOMotionDetector/SOMotionDetector.framework"
  install_framework "${PODS_ROOT}/SparkSDK/MediaEngine/Wme.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SparkSDK/SparkSDK.framework"
